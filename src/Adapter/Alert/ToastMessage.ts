...
class ToastMessages {
    ...
    TOAST_LONG_BOTTOM(text: string): void {
        Toast.showWithGravity(text, this.time.long, this.position.bottom, this.style);
    }
    TOAST_LONG_CENTER(text: string): void {
        Toast.showWithGravity(text, this.time.long, this.position.center, this.style);
    }
    ...
    TOAST_SHORT_BOTTOM(text: string): void {
        Toast.showWithGravity(text, this.time.short, this.position.bottom, this.style);
    }
    TOAST_SHORT_CENTER(text: string): void {
        Toast.showWithGravity(text, this.time.short, this.position.center, this.style);
    }
}
